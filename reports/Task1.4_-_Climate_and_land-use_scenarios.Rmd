...
The land use data is available in 5-year timesteps from 2015 to 2100 with a resolution of 1km for fifteen climate scenarios and the same five GCMs available for climate data. In this work, the SSP 1 – RCP 2.6 and SSP 5 – RCP 8.5 scenarios and the average of the GCMs are used. All the land use layers are available in [Chen et al. (2020)](#chen).
