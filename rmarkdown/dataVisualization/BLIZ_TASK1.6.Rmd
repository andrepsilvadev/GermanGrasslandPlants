...
ggsave(plot = abund_plot2, file = "Abundance_through_time.tiff", bg = "transparent", width = 170, height = 100, units = "mm", dpi = 1200, compression = "lzw")
```
...
#ggsave(plot = reprod_plot, file = "Reproduction_through_time.tiff", bg = "transparent", width = 170, height = 100, units = "mm", dpi = 1200, compression = "lzw")
```
...
#ggsave(plot = habitat_plot, file = "Habitat_suitability_through_time.tiff", bg = "transparent", width = 170, height = 100, units = "mm", dpi = 1200, compression = "lzw")
```
...
#ggsave(plot = carry_cap_plot, file = "Carrying_capacity_through_time.tiff", bg = "transparent", width = 170, height = 100, units = "mm", dpi = 1200, compression = "lzw")
```
...
#ggsave(plot = mort_plot, file = "Mortality_through_time.tiff", bg = "transparent", width = 170, height = 100, units = "mm", dpi = 1200, compression = "lzw")
```
...
#ggsave(plot = abund_mismatch_plot, file = "Abundance_mismatch.tiff", bg = "transparent", width = 170, height = 100, units = "mm", dpi = 1200, compression = "lzw")
```
...
#ggsave(plot = sp_corr_plots, file = "correlation_plots_species.tiff", bg = "transparent", width = 170, height = 100, units = "mm", dpi = 1200, compression = "lzw")
```
...
#Save abundance mismatch per scenario plot
#ggsave(plot = sens_analysis, file = "Sensitivity_analysis.tiff", bg = "transparent", width = 170, height = 100, units = "mm", dpi = 1200, compression = "lzw")
```
