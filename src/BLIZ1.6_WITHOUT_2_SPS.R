...
# This script uses data for the "normal" analysis from the 6th September 2024
# No changes to the code were made, the data changed to include the burn-in period (that was forgotten in previous scripts)
# only figures going on Jana's paper are available in this script check BLIZ1.6_Sept.R for the full code with other unused plots

# HERE WE REMOVED VIOLA ARVENSIS AND ERIOPHORUM VAGINATUM FROM THE DATA 
...
write.csv(mean_stDEV, "./24Sept2024/mean_values_25Sept_without_2sps.csv", row.names=FALSE)
invisible(gc())
...
#ggsave(plot = abund_plot, file = "./24Sept2024/Abundance_through_time_Sept_without2sps_paletteR4.tiff", bg = 'white', width = 200, height = 180, units = "mm", dpi = 1200, compression = "lzw")
...
# write table into .csv file
write.csv(abund_quant, "./24Sept2024/abundance_quantification_25Sept_without_2sps.csv", row.names=FALSE)
invisible(gc())
...
#ggsave(plot = reprod_plot, file = "./Jana_thesis/Reproduction_through_time_25Sept_without2sps_paletteR4.tiff",  bg = 'white', width = 250, height = 230, units = "mm", dpi = 1200, compression = "lzw")
...
#ggsave(plot = habitat_plot, file = "./Jana_thesis/Habitat_suitability_through_time_25Sept_without2sps_paletteR4.tiff",  bg = 'white', width = 250, height = 230, units = "mm", dpi = 1200, compression = "lzw")
...
#ggsave(plot = carry_cap_plot, file = "./Jana_thesis/Carrying_capacity_through_time_25Sept_without2sps_paletteR4.tiff",  bg = 'white', width = 250, height = 230, units = "mm", dpi = 1200, compression = "lzw")
...
#ggsave(plot = mort_plot, file = "./Jana_thesis/Mortality_through_time_25Sept_without2sps_paletteR4.tiff",  bg = 'white', width = 250, height = 230, units = "mm", dpi = 1200, compression = "lzw")
...
# saving the plot
#ggsave(plot = abund_mismatch_plot2, file = "./24Sept2024/Abundance_mismatch_SeptWITHOUT_OUTLIERS_without2sps_original.tiff",  bg = 'white', width = 250, height = 280, units = "mm", dpi = 1200, compression = "lzw")
invisible(gc())
...
# saving the plot
#ggsave(plot = abund_mismatch_plot_red_blue, file = "./24Sept2024/Abundance_mismatch_SeptWITHOUT_OUTLIERS_without2sps_red_blu.tiff",  bg = 'white', width = 250, height = 280, units = "mm", dpi = 1200, compression = "lzw")
invisible(gc())
...
# saving the plot
#ggsave(plot = abund_mismatch_plot_gradient, file = "./24Sept2024/Abundance_mismatch_SeptWITHOUT_OUTLIERS_without2sps_gradient.tiff",  bg = 'white', width = 250, height = 280, units = "mm", dpi = 1200, compression = "lzw")
invisible(gc())
...
# saving the plot
#ggsave(plot = abund_mismatch_plot_GWF, file = "./24Sept2024/Abundance_mismatch_SeptWITHOUT_OUTLIERS_without2sps_GWF.tiff",  bg = 'white', width = 250, height = 280, units = "mm", dpi = 1200, compression = "lzw")
invisible(gc())
...
# saving the plot
# ggsave(plot = abund_mismatch_plot_GWF_withoutliers, file = "./Jana_thesis/Abundance_mismatch_SeptWITH_OUTLIERS_without2sps_GWF.tiff",  bg = 'white', width = 250, height = 280, units = "mm", dpi = 1200, compression = "lzw")
invisible(gc())
...
for (scenario in scenarios) {
  ...
  ggsave(paste0("./24Sept2024/abundance_change_prop_map_scenario_without2sps", scenario, ".tiff"), abundance_change_prop_map, bg = 'white', width = 230, height = 210, units = "mm", dpi = 1200, compression = "lzw")
}
...
# write table into .csv file
write.csv(abund_chnage_prop_quant, "./24Sept2024/proportion_of_abundance_quantification_25Sept_without_2sps.csv", row.names=FALSE)
invisible(gc())
...
ggsave(plot = spatial_hotspots_map, file = "./24Sept2024/Spatial_hotspots_map_without2sps.tiff",  bg = 'white', width = 210, height = 210, units = "mm", dpi = 1200, compression = "lzw")
...
# saveWorkbook(wb, file = "./24Sept2024/Prop_abundance_chnage_dataframes_without2sps.xlsx", overwrite = TRUE)
# invisible(gc())
# 
...
correlation_plot <- ggplot(corr_data_scenarios, aes(x = habitat_change, y = abund_change, color = scenario)) +
  ...
  theme(panel.background =  element_blank(), # no background colour
        ...
        legend.position = "bottom")
invisible(gc) 
ggsave(plot = correlation_plot, file = "./24Sept2024/Correlation_plots_scenarios_25Sept_without2sps.tiff",  bg = 'white', width = 210, height = 270, units = "mm", dpi = 1200, compression ="lzw")
